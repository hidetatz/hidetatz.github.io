...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},r,s]}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
begin:s+n+"$"}]}}})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(...e){
...
},{className:"string",begin:/'/,end:/'/},n]}}})());hljs.registerLanguage("json",(()=>{"use strict";return n=>{const e={
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}})());hljs.registerLanguage("javascript",(()=>{"use strict"
...
end:/$/}]})})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},r]}}})());hljs.registerLanguage("swift",(()=>{"use strict";function e(e){
...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("rust",(()=>{"use strict";return e=>{
...
},{begin:e.IDENT_RE+"::",keywords:{built_in:t}},{begin:"->"}]}}})());hljs.registerLanguage("sql",(()=>{"use strict";function e(e){
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})());hljs.registerLanguage("ini",(()=>{"use strict";function e(e){
...
starts:{end:/$/,contains:[i,c,r,t,l,a]}}]}}})());hljs.registerLanguage("python",(()=>{"use strict";return e=>{const n={
...
},{className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[b,c,t]}]}}})());hljs.registerLanguage("xml",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(e){return a("(?=",e,")")}
...
endsParent:!0}]}]}}})());hljs.registerLanguage("cpp",(()=>{"use strict";function e(e){
...
className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}})());hljs.registerLanguage("c",(()=>{"use strict";function e(e){
